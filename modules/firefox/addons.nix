pkgs: [
  (pkgs.fetchFirefoxAddon {
    ...
    sha256 = "1yah42dziimdzpzfmdbfyc84a3r5vfag107s4x5kqqcw2csswq83";
  })
  (pkgs.fetchFirefoxAddon {
    name = "clearurls";
