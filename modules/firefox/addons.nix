pkgs: [
  ...
  (pkgs.fetchFirefoxAddon {
    name = "refined-github-";
    url = "https://addons.mozilla.org/firefox/downloads/file/3855406/refined_github-21.10.18-an+fx.xpi";
    sha256 = "0ayxqbrzgpmgbm6anzh8h7416xf9wwv41qbzidnkxj98alpgrq0h";
  })
  (pkgs.fetchFirefoxAddon {
    name = "sponsorblock";
