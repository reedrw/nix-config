pkgs: [
  ...
  (pkgs.fetchFirefoxAddon {
    ...
    sha256 = "0vm679cf5ms8k305ranim8jk23dz621k2c4j42b4k7x3df12lff7";
  })
  (pkgs.fetchFirefoxAddon {
  ...
  (pkgs.fetchFirefoxAddon {
    ...
    sha256 = "0ysi98khj174z71g1xgncwg3xim5dfgzvqdarjy2zf03fiscr37h";
  })
  (pkgs.fetchFirefoxAddon {
    name = "sponsorblock";
  ...
  (pkgs.fetchFirefoxAddon {
    ...
    sha256 = "0i318rhg1rs12j4lx424smjkrwd2l0cwcsfw574wwamx8qamhk3m";
  })
  (pkgs.fetchFirefoxAddon {
    name = "FrankerFaceZ";
