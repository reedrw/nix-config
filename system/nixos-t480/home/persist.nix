...
let
  ...
  homDirs = builtins.filter (x: lib.hasPrefix homeDir x) json.directories;
  ...
  directories = builtins.map (v: builtins.substring (builtins.stringLength homeDir) 999999999 v) homDirs;
in
{
  # imports = [
